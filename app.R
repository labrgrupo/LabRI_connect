...
# D.4. Observer to Clear Configuration
...
# D.5. Observer to Generate Report (with progress tracking)
  
  
  # D.5.1. Reactive values for progress tracking
  ...
  # D.5.1.1. Chunk labels for progress display
  ...
  observeEvent(input$generate_report, {
    ...
    ## D.5.3. Setup progress tracking file
