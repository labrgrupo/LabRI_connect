...
load_or_initialize_data <- function() {
  params_file <- file.path(tempdir(), "saved_params.Rds")
...
ui <- fluidPage(
  ...
  tags$head(
    ...
    tags$style(HTML("
      ...
      /* Responsive header */
      .labri-header {
        background: linear-gradient(to bottom, #062d79, #4a7ad8);
        padding: 14px 18px;
        display: flex;
        align-items: center;
        gap: 18px;
  ...
  tags$div(
    ...
    ## C.2.1. LabR Tools Logo
    tags$div(
      class = "labri-header-logo",
      img(src = "logo.png", alt = "Logo")
    ),
    
    ## C.2.2. Sub-div for Title and Subtitle
    tags$div(
      class = "labri-header-text",
      
      ### C.2.2.1. Main Title of the Application
      h1(
        "Laboratory Reference Interval (LabRI) (v5.0.0)",
        class = "labri-header-title"
      ),
      
      ### C.2.2.2. Subtitle Below the Main Title
      tags$p(
        "Tool for Estimating and Verifying Reference Intervals",
        class = "labri-header-subtitle"
      )
    )
  ),
      ...
      sidebarLayout(
        ...
        sidebarPanel(
          ...
          tags$h2(
            ...
            style = "color: #4878d5; margin-top: 25px; margin-bottom: 25px;"
          ),
          textInput(
            "responsible_person",
          ...
          tags$p(
            tags$strong("NOTE 1:"),
            " Provide the name of the person responsible for the process or analysis performed.",
            style = "font-size: 12px; color: #666; margin-top: -10px; margin-bottom: 20px;"
          ),
          ...
          tags$p(
            tags$strong("NOTE 2:"),
            " Select the data file to be analyzed. The file must be in .csv, .xls, or .xlsx format.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -15px; margin-bottom: 25px;"
          ),
          ...
          tags$p(
            tags$strong("NOTE 3:"),
            " Select the column name from the dropdown list containing the data to be analyzed.",
          ...
          tags$p(
            tags$strong("NOTE 4:"),
            " Select 'Yes' if the measurand name is the same as the column name in the dataset, or 'No' otherwise. If 'No' is selected, an additional field will appear to specify a custom measurand name, which will be used in the HTML report generated by the tool.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          ...
          tags$p(
            tags$strong("NOTE 5:"),
            " Provide the data source, specifying where the dataset was obtained from.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          tags$hr(style = "border-top: 3px solid #4878d5; margin: 15px 0;"),
          
          #### C.3.1.1.3. Input: Set the Type of Reference Interval and Decimal Places
          tags$h2(
            "Set the Type of Reference Interval and Decimal Places",
            style = "color: #4878d5; margin-top: 25px; margin-bottom: 25px;"
          ),
          radioButtons(
            "ri_type",
          ...
          tags$p(
            tags$strong("NOTE 6:"),
            " Select the desired type of reference interval. The default setting is 'Double-sided,' which calculates both the lower and upper reference limits. 'Right-sided' considers only the upper reference limit.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          
          selectInput(
            "ci_level",
            "Choose the confidence level applied to the estimation of reference interval limits:",
          ...
          tags$p(
            tags$strong("NOTE 7:"),
            " Select the desired confidence level for estimating the reference limits. The available options are 90%, 95%, and 99%. If no selection is made, the tool will apply a default confidence level of 90%.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          ...
          numericInput(
            "decimal_places",
            "Decimal Places:",
            saved_params$decimal_places,
            min = 0
          ),
          tags$p(
            tags$strong("NOTE 8:"),
            " Provide the desired number of decimal places for the results. If left blank, the default value will be 2 decimal places.",
            style = "font-size: 12px; color: #666; margin-top: -10px; margin-bottom: 25px;"
          ),
          tags$hr(style = "border-top: 3px solid #4878d5; margin: 15px 0;"),
          
          #### C.3.1.1.4. Input: Information for Study Traceability
          tags$h2(
          ...
          tags$p(
            tags$strong("NOTE 9:"),
            " Describe the measurement procedure and the analytical method used. This method is the practical process that applies the analytical principle to obtain the result.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          ...
          tags$p(
            tags$strong("NOTE 10:"),
            " Describe the unit of measurement for the measurand (e.g., mg/dL, g/dL, mmol/L etc.).",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          ...
          textInput(
            "specimen",
            "Sample Type:",
            saved_params$specimen,
            width = "100%"
          ),
          tags$p(
            tags$strong("NOTE 11:"),
            " Describe the sample type (e.g., whole blood, serum, plasma, 24-hour urine, random urine etc.).",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          ...
          textInput(
            "age_range",
            "Age Range:",
            saved_params$age_range,
            width = "100%"
          ),
          tags$p(
            tags$strong("NOTE 12:"),
            " Describe the age range concisely to ensure readability in the HTML report. Suggested formats for reporting the age range include simple, direct expressions like '7 to 16 years', 'under 2 years', '7 - 16 years', '< 2 years' etc.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          ...
          tags$p(
            tags$strong("NOTE 13:"),
            " Describe the sex concisely to ensure readability in the HTML report. Suggested formats include simple, direct expressions like 'Male', 'Female', 'M', 'F', 'Male and Female', 'M and F' etc.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          ...
          tags$div(
            ...
            tags$ul(
              tags$li(
                tags$strong("Exclude potentially pathological results:"),
              ...
              tags$li(
                tags$strong("Remove data from specific departments (e.g., oncology, Intensive Care Unit, Home Care etc):"),
                " These departments typically handle patients in critical conditions that can significantly alter results.",
                style = "margin-bottom: 10px;"
              ),
              tags$li(
                tags$strong("Limit the frequency of results per patient within the study period:"),
          ...
          #### C.3.1.1.5. Input: Provide the Comparative Reference Interval (if applicable)
          tags$h2(
          ...
          tags$div(
            tags$p(
              tags$strong("NOTE 15:"),
              "To perform reference interval verification, a comparative reference interval must be provided. This comparative reference interval can be selected from various sources, such as:",
              style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 15px;"
            ),
            tags$ul(
              tags$li(
                tags$strong("Reagent Kit Package Inserts: "),
                " Specified reference ranges for laboratory tests based on manufacturer's validation studies.",
                style = "margin-bottom: 10px;"
              ),
              tags$li(
                tags$strong("Scientific publications and guidelines from specialized organizations: "),
                "Intervals derived from multicenter studies and reviews that reflect widely accepted practices in the field.",
                style = "margin-bottom: 10px;"
              ),
              tags$li(
                tags$strong("Academic Books (Textbooks): "),
          ...
          tags$p(
            tags$strong("NOTE 16:"),
            " If a Comparative Reference Interval is not specified, the reference interval estimated by the LabRI method itself will be used as the comparative reference. This is because the verification module algorithms of the LabRI method require a comparative reference to perform the verification.",
            style = "font-size: 12px; color: #666; text-align: justify; margin-top: -10px; margin-bottom: 25px;"
          ),
          tags$hr(style = "border-top: 3px solid #4878d5; margin: 15px 0;"),
          
          #### C.3.1.1.6. Define the subsampling approach used in the study (if applicable)
          tags$h2(
          ...
          tags$p(
            tags$strong("NOTE 17:"),
            " If no maximum subsample size is provided, a default value of 10,000 observations will be applied. In the LabRI method study, this threshold was used to balance computational efficiency with the retention of a dataset size considered adequately representative of the population served by the laboratory.",
          ...
          tags$div(
            ...
            tags$a(
              tags$span(
                ...
                style = "text-align: justify; margin-right: 5px;"
              ),
              tags$img(
            ...
            tags$p(
              tags$strong("NOTE 18:"),
              " To submit an issue report, you need to have a GitHub account and be logged in.",
  ...
  tags$footer(
    tags$p(
      ...
      tags$a(
        ...
        tags$span("GitHub", style = "font-size: 12px;")
      ),
      ...
      tags$a(
        ...
        tags$span("Lab R Group Website", style = "font-size: 12px;")
      )
    ),
...
server <- function(input, output, session) {
  ...
  # D.1. Define a Temporary Directory for the Report
  
  
  output_dir <- tempdir()
  
  
  # D.2. Reactive Function to Load the File and Read Columns
  ...
  # D.4. Observer to Save Configuration
  ...
  # D.5. Observer to Clear Configuration
  ...
  # D.6. Observer to Generate Report (with progress tracking)
  
  
  # D.6.0. Reactive values for progress tracking
  rv <- reactiveValues(
    rendering = FALSE,
    bg_process = NULL,
    progress_file = NULL,
  ...
  # D.6.0.1. Chunk labels for progress display
  ...
  observeEvent(input$generate_report, {
    ...
    ## D.6.2. Setup progress tracking file
    ...
    ## D.6.4. Launch background R process for rendering (no callr needed)
    ...
    # Write a temporary R script that does the rendering
    render_script <- tempfile(fileext = ".R")
    
    # Escape backslashes for Windows paths
    esc <- function(x) gsub("\\\\", "/", x)
    
    # Build the R script content
    script_lines <- c(
      paste0('setwd("', esc(working_dir), '")'),
      '',
      '# Setup pandoc',
      paste0('pandoc_local <- file.path("', esc(working_dir), '", "pandoc")'),
      'if (dir.exists(pandoc_local)) {',
      '  Sys.setenv(RSTUDIO_PANDOC = pandoc_local)',
      paste0('} else if (nzchar("', pandoc_dir, '")) {'),
      paste0('  Sys.setenv(RSTUDIO_PANDOC = "', esc(pandoc_dir), '")'),
      '}',
      '',
      '# Progress logging function',
      paste0('pf <- "', esc(progress_file), '"'),
      ...
      '  if (before) log_progress(paste0("CHUNK_START|", options$label))',
      '  else log_progress(paste0("CHUNK_END|", options$label))',
      '  NULL',
      '})',
      'knitr::opts_chunk$set(labri_progress = TRUE)',
      '',
      '# Render params',
      paste0('rmd_params <- list('),
      paste0('  File_Name = "', esc(input$file_name$datapath), '",'),
      paste0('  Column_Name = "', input$column_name, '",'),
      paste0('  Double_sided = "', ifelse(input$ri_type == "Double-sided", "x", ""), '",'),
      paste0('  Right_sided = "', ifelse(input$ri_type == "Right-sided", "x", ""), '",'),
      paste0('  CI_level = ', input$ci_level, ','),
      paste0('  Number_of_decimal_places = "', as.character(input$decimal_places), '",'),
      paste0('  Responsible_person = "', gsub('"', '\\\\"', input$responsible_person), '",'),
      paste0('  Measurement_procedure_and_analytical_method = "', gsub('"', '\\\\"', input$measurement_procedure), '",'),
      paste0('  measurand_name = "', input$measurand_name, '",'),
      paste0('  Name_of_measurand = "', gsub('"', '\\\\"', input$name_of_measurand), '",'),
      paste0('  Unit_of_measurement = "', gsub('"', '\\\\"', input$unit), '",'),
      paste0('  Type_of_specimen = "', gsub('"', '\\\\"', input$specimen), '",'),
      paste0('  Age_range = "', gsub('"', '\\\\"', input$age_range), '",'),
      paste0('  Sex = "', gsub('"', '\\\\"', input$sex), '",'),
      paste0('  Exclusion_criteria = "', gsub('"', '\\\\"', input$exclusion_criteria), '",'),
      paste0('  Data_source = "', gsub('"', '\\\\"', input$data_source), '",'),
      paste0('  Upper__Reference__Limit__of__Comparative_Reference = "', input$upper_ref_limit, '",'),
      paste0('  Lower__Reference__Limit__of__Comparative_Reference = "', input$lower_ref_limit, '",'),
      paste0('  Source_of_comparative_reference_used = "', gsub('"', '\\\\"', input$comp_ref_source), '",'),
      paste0('  Maximum_sample_size = "', as.character(input$max_sample_size), '"'),
      ')',
      '',
      'tryCatch({',
      paste0('  rmarkdown::render('),
      paste0('    input = "', esc(rmd_path), '",'),
      paste0('    output_file = "', esc(output_file), '",'),
      '    params = rmd_params,',
      '    envir = globalenv()',
      '  )',
    ...
    writeLines(script_lines, render_script)
    ...
    system2(rscript_exe, args = c("--vanilla", render_script), 
            wait = FALSE, stdout = FALSE, stderr = FALSE)
  })
  
  
  # D.6.5. Poll progress file and update modal
  observe({
    req(rv$timer_active)
